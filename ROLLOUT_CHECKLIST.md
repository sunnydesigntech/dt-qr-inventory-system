...
- tapping `Scan QR` navigates the current tab to the standalone HTTPS scanner first when `EXTERNAL_SCANNER_URL` is configured; the workflow must not depend on popup/new-tab behaviour
