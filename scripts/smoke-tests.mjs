...
assert.match(scannerHtml, /Camera diagnostics/);
assert.match(scannerHtml, /copyDiagnosticsBtn/);
assert.match(scannerHtml, /function collectCameraDiagnostics/);
assert.match(scannerHtml, /function cameraDiagnosticsReport/);
assert.match(scannerHtml, /navigator\.permissions\.query\(\{ name: 'camera' \}\)/);
...
assert.match(appScript, /function scannerEvidenceReport/);
assert.match(appScript, /function copyScannerEvidenceReport/);
assert.match(appScript, /data-action="scanner-copy-report"/);
assert.match(appScript, /Phone camera result: \[pass\/fail\]/);
